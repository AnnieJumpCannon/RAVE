...
we will construct a simplified model that does not include detailed abundances, before
demonstrating how we (1) improve upon the imprecise metallicities for main-sequence/sub-giant
stars, and (2) translate abundances from the giant branch stars to the main-sequence/sub-giant
branch sample.
