...
% RAVE builders
\author{Joss Bland-Hawthorn, Brad K. Gibson, Arnaud Siebert, Olivier Bienayme, Julio F. Navarro}
...
%Observatoire astronomique de Strasbourg, Universit\'e de Strasbourg, CNRS, UMR 7550, 11 rue de l?Universit\'e, F-67000 Strasbourg, France
%Senior CIfAR Fellow; Department of Physics and Astronomy, University of Victoria, Victoria, BC, Canada V8P 5C2
...
\stub{State these are empirically chosen normalization factors, and how}
The artefacts 
...
and the giant star model, are available on request. \stub{should we put them online somewhere
...
consistent with being members of globular clusters: 49 stars belonging to NGC~5139 ($\omega$~Centauri), 11 members of the retrograde globular cluster NGC~3201, and 10 members of NGC~362. In addition to these systems, 12 stars thought to belong to NGC~1851 were found in the RAVE data in \cite{Kunder_2014} and 10 stars in NGC~6752 and XX stars in \stub{47~Tuc} were discussed in \citep{Kunder_2016}. For a detailed description of the cluster membership for NGC~5139, NGC~3201, and NGC~362 we refer the reader to \cite{Anguiano_2015}. The membership selection for NGC~1851 can be found in \citep{Kunder_2014} and for NGC~6752 and 47~Tuc can be found in \cite{Kunder_2016}. We note here that we have not re-evaluated cluster membership as that is beyond the scope of the paper, however with the results presented here it is possible to study these systems in further detail. 
...
%check if NGC 6571 has anticorrelations present
...
%Mean metallicity of NGC3201 cluster = -0.75 +/- 0.20
%Mean metallicity of NGC362 cluster = -0.92 +/- 0.48
%Mean metallicity of NGC5139 cluster = -0.85 +/- 0.55
%Mean metallicity of NGC6752 cluster = -1.17 +/- 0.30
...
%Mean metallicity of Hyades cluster = 0.07 +/- 0.09 (26 stars)
%Mean metallicity of IC4651 cluster = 0.15 +/- 0.12 (13 stars)
%Mean metallicity of M67 cluster = -0.02 +/- 0.17 (30 stars)
%Mean metallicity of Pleiades cluster = -0.02 +/- 0.12 (78 stars)
