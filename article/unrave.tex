...
data release: $\approx$292,036 stars.  We used the \gaia\ universe model snapshot 
...
physics-based models used in \rave\ data releases 2--5.
 Specifically, we will use an implementation of \thecannon\
