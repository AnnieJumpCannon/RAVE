...
up to 264,276 stars.  We present a data-driven re-analysis of \rave\ 
...
Using positions, proper motions, and metallicities from the \rave\ official
data release (such that they can be used as comparison), we identify $\sim$160 
...
cluster centre to have: radial velocities between 36~km~s$^{-1}$ and 44~km~s$^{-1}$,
...
training set used in the simple model still project as systematic artefacts.  
