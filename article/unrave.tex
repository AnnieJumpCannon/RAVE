...
Any inferences based upon these results should be made with the recognition of those caveats,
and acknowledge that they are subject to our explicit assumptions, some of which are 
provably incorrect.

\stub{assumptions that are provably wrong: accurate labels in the training set. lol}
...
\citep{Fulbright,Ruchti,elsewhere}, but it is unknown if the stellar parameters are
...
\stub{Metallicities on the main-sequence and giant branch -- we cannot be sure if they
are correct. Are there any indications that we can get which suggest whether they are
good or bad?}
...
\stub{assumptions that are provably wrong: RAVE spectral resolution}

\stub{assumptions that are provably wrong: correlated noise in the RAVE spectra -- this is minor and unlikely to cause a real issue}
