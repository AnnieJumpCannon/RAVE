...
\item The training set has mean accurate labels.  Note
...
trivial.  There are no spectroscopic studies that both extend the range of stellar types
we are interested in (e.g., FGKM-type stars), and have a large enough sample size that
...
\caption{\label{fig:joint-model-differences}}
\end{figure}
