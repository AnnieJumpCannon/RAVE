...
quadrature sum of their formal uncertainties $(\logg_a - \logg_b)/\sqrt{{\sigma_{\logg,a}}^2 + {\sigma_{\logg,b}}^2}$.  If our derived labels and formal errors were 
correct, the distribution of these pair-wise comparisons would be
...
as a normal survey star.  We inferred labels for the stacked spectra 
using all three models, and derived a joint estimate as per Section 
\ref{sec:joining-the-models}.  The labels we inferred from the stacked 
