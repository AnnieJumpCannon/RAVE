...
% The giant training set has many abundances.
% Which elements?
% Tests involving censoring? --> Just indicates that many of these lines are blended.
% So we will use regularization instead of censoring

% Set hyper-parameters by LOO-CV

% Trained this and rain it on all RAVE spectra.
