...
we recommend either a thorough investigation of unexpected structure
\footnote{Before submitting to \emph{Nature}} 
using all the available 
information from \rave, or judicious quality controls (e.g., requiring the 
morphological classification to be `normal') to remove these spurious measurements.
