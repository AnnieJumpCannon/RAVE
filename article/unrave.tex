...
% TODO: Final checks based on released version.
...
\begin{document}
\title{The \project{unRAVE} catalog of stellar atmospheric parameters and\\
chemical abundances for chemo-dynamic studies in the \gaia\ era}

\author{Andrew R. Casey\altaffilmark{1}, Keith Hawkins\altaffilmark{1}, David W. Hogg\altaffilmark{2,3,4,5}, Melissa Ness\altaffilmark{5}, Hans Walter-Rix\altaffilmark{5}, Georges Kordopatis\altaffilmark{6}, Andrea Kunder\altaffilmark{6}, Matthias Steinmetz\altaffilmark{6}, Harry Enke\altaffilmark{6}, Jason Sanders\altaffilmark{1}, Sergey Koposov\altaffilmark{1}, Gerry Gilmore\altaffilmark{1}, Toma\v{z} Zwitter\altaffilmark{6}, Kenneth C. Freeman\altaffilmark{7}, Luca Casagrande\altaffilmark{7}, 
Gal Matijevic\altaffilmark{6}, George Seabroke\altaffilmark{8}, Olivier Bienayme\altaffilmark{9}, 
Joss Bland-Hawthorn\altaffilmark{10}, Brad K. Gibson\altaffilmark{11}, Eva~K.~Grebel\altaffilmark{12}, Amina Helmi\altaffilmark{13}, Ulisse Munari\altaffilmark{14}, Julio F. Navarro\altaffilmark{15,16}, Warren Reid\altaffilmark{17,18}, Arnaud Siebert\altaffilmark{19}, Rosemary Wyse\altaffilmark{20}\\
\vspace{2em}
...
complement that includes radial velocities, stellar atmospheric parameters, and 
...
$\approx$250,000 stars.  We present a data-driven re-analysis of \rave\ 
spectra using \thecannon, and we provide more precise and accurate stellar
parameters and abundances than available in previous \rave\ data releases. 
We constructed our model using high-fidelity \apogee\ stellar parameters 
and abundances for red giant branch stars that overlap with \rave, and 
stellar parameters from the \project{K2}/\project{Ecliptic Pole Input 
Catalog} for main-sequence and sub-giant branch stars.  We derive, and 
validate, improved effective temperature $\teff$, surface gravity $\logg$, 
and chemical abundances of up to seven elements (O, Mg, Al, Si, Ca, Fe, Ni) 
for \Nstarsqc\ stars.  In total we report \Nabundances\ elemental 
abundances, with a typical precision of 0.07~dex.  The \unrave\ catalog 
presented here, in conjunction with \tgas, represents the most powerful 
data set for chemo-dynamic analysis at the dawn of broadly available 
\gaia\ data.
\end{abstract}
...
% TODO: Sanders: 292,036; Kunder: 264,276
...
with other high-resolution studies, here we verify that the abundances we find
are consistent with expectations from astrophysics.  In the \rave\ survey, 
\cite{Anguiano_2015} identified 70 stars with positions and radial velocities that are
...
\citet[][accessed 6 September 2016]{Harris_1996} online catalog of globular 
...
consistent with high-resolution studies \citep{Marino_2011,Carretta_2009,Carretta_2013}. 
Based on the pre-defined membership criteria, we find the mean metallicity
of $\omega$-Centauri to be $[{\rm Fe/H}] = -0.85$.  However, it is clear that the 
membership criteria could be improved with our revised metallicities and 
detailed chemical abundances.  Indeed, our individual abundance labels could 
be used to identify globular cluster members that are now tidally disrupted 
...
weighting has no warranty to be (formally) correct, and may introduce inconsistencies
or systematic errors rather than minimizing them.  
...
of high fidelity because we have limited quality metrics available.  Moreover, there
is no guarantee that the stellar parameters \emph{or} abundances are on the same scale
as \apogee\ \citep[and good reasons to believe they will not be; see][]{Smiljanic_2014}.
...
training set used in the simplest model still project as systematic artefacts.  
...
We have included a boolean flag column in our catalog for quality control,
to signify whether a result is thought to be reasonable.  Specifically, 
stars where \texttt{SPARV} indicates a $\teff > 8000$~K do not meet our quality 
control flag.  For all other stars, we further require $\chi_r^2 < 3$ and
$S/N >10$~pixel$^{-1}$.  These quality constraints represent the minimum
acceptable constraints and should not be taken verbatim: judicious use of
the morphological classifications \citep{Matijevic_2012} or additional 
metadata from the \rave\ pre-processing pipelines is strongly encouraged.


We have presented a comprehensive collection of precise stellar abundances 
for stars in the first \gaia\ data release.  In total we derive reliable 
stellar atmospheric parameters for \Nstarsqc, and report more than 1.69 
million abundances.  Despite the caveats and limitations discussed here, 
our validation experiments and comparisons with high-resolution 
spectroscopic studies suggests that our results have sufficient accuracy 
and precision to be useful for chemo-dynamic studies that become imminently 
feasible only in the era of \gaia\ data.  Indeed, we are optimistic that 
the \unrave\ catalog will advance understanding of the Milky Way's 
...
at \texttt{\url{ZENODO-URL}} \citep{ZENODO-CITATION}.  These results are also available
...
\caption{Effective temperatures $\teff$ and surface gravities $\logg$ from this work, where each hexagonal bin is colored by the \emph{maximum} temperature for any star in that bin, as reported by the \rave\ pre-processing pipeline \texttt{SPARV} \citep{Steinmetz_2006,Zwitter_2008}.  Hot stars are not included in our training set, and appear above the turnoff in our labels.  For this reason, we supply a boolean quality control flag \texttt{QC} that flags stars with $\teff > 8000$~K (as reported by \texttt{SPARV}), and other results that are of poor quality.\label{fig:hot-stars}}
\end{figure}
...
\altaffiltext{3}{Center for Cosmology and Particle Physics, Department of Physics, New York University, 4 Washington Pl., room 424, New York, NY 10003, USA}
...
\altaffiltext{6}{University of Ljubljana, Faculty of Mathematics and Physics, Jadranska 19, 1000 Ljubljana, Slovenia}
\altaffiltext{7}{Research School of Astronomy and Astrophysics, Mount Stromlo Observatory, The Australian National University, ACT 2611, Australia}
\altaffiltext{8}{Mullard Space Science Laboratory, University College London, Holmbury St Mary, Dorking, RH5 6NT, UK}
\altaffiltext{9}{Observatoire astronomique de Strasbourg, Universit\'e de Strasbourg, CNRS, UMR 7550, 11 rue de l?Universit\'e, F-67000 Strasbourg, France}
\altaffiltext{10}{Sydney Institute for Astronomy, School of Physics, University of Sydney, NSW 2006, Australia}
\altaffiltext{11}{E.A. Milne Centre for Astrophysics, University of Hull, Hull, HU6 7RX, United Kingdom}
\altaffiltext{12}{Astronomisches Rechen-Institut, Zentrum f\"ur Astronomie der Universit\"at Heidelberg, M\"onchhofstr.\ 12--14, 69120 Heidelberg, Germany}
\altaffiltext{13}{Kapteyn Astronomical Institute, University of Groningen, P.O. Box 800, 9700 AV Groningen, The Netherlands}
\altaffiltext{14}{INAF Astronomical Observatory of Padova, 36012 Asiago (VI), Italy}
\altaffiltext{15}{Department of Physics and Astronomy, University of Victoria, Victoria, BC, Canada V8P 5C2}
\altaffiltext{16}{Senior CIfAR Fellow}
\altaffiltext{17}{Department of Physics and Astronomy, Macquarie University, Sydney, NSW 2109, Australia}
\altaffiltext{18}{Western Sydney University, Penrith South DC, NSW 1797}
\altaffiltext{19}{Observatoire astronomique de Strasbourg, Universit\'e de Strasbourg, CNRS, UMR 7550, 11 rue de l?Universit\'e, F-67000 Strasbourg, France}
\altaffiltext{20}{Johns Hopkins University, Baltimore, MD, USA}
