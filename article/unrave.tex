...
30~per~pixel$^{-1}$; and $\teff \leqslant 6750$.  Unfortunately these strict constraints
...
likelihood of misclassification.  The distilled sample of the \rave--\epic\ overlap
catalog contains 583 stars (of 4,611).


% We can also identify misclassified stars by cross-validation.
