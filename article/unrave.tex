...
We inferred labels for all \rave\ spectra using this main-sequence/sub-giant star model.  \stub{from Zwitter: ensure it is clear that we say we are running this model on all spectra}
...
\stub{In Figure \ref{fig:repeat-visits} we look at the difference as a function of SNR}
