...
use of the information content for red giant branch star, and provides significant a
improvement in stellar parameter ($\teff$, $\logg$, [Fe/H]) precision over previous
\rave\ data releases.  When combined with \gaia/\tgas, these results provide a powerful
compendium for chemo-dynamic studies of the Milky Way.  However, our results have caveats.
Any inferences based upon these results should be made with the recognition of those caveats,
and acknowledge that they are subject to our explicit assumptions.
...
% Caveats in the results:
% MULTIPLE MODELS
% HETEROGENEOUS TRAINING SET
% METAL POOR ABUNDANCES

% UNSURE IF TWO ABUNDANCE SCALES ARE ON THE SAME SCALE --!
% even if they are on the same scale...
% metal-poor dwarfs/sub-giants

% quality constraints recmomended
...
% Validate through literature comparisons
